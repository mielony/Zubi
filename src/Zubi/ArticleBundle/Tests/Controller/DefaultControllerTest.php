...
class DefaultControllerTest extends WebTestCase
{
    ...
    //zakładam że jest art o id = 1
     public function testAEditArticleGoodUser()
    {       
         $client = static::createClient(array(), array(
            'PHP_AUTH_USER' => 'b@b.pl',
            'PHP_AUTH_PW'   => '1234'
            ));
        $crawler = $client->request('GET', '/article/edit/1');        
        $this->assertTrue($client->getResponse()->getStatusCode() == '200' ,
                "Response code is: ".$client->getResponse()->getStatusCode().
                "not 200!!!!");       
    ...
    public function testEditArticleGoodUserGoodData()
    {       
         $client = static::createClient(array(), array(
            'PHP_AUTH_USER' => 'b@b.pl',
            'PHP_AUTH_PW'   => '1234'
